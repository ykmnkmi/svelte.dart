...
import 'package:svelte_builder/src/transform/context.dart';

class TransformError extends Error {
  TransformError(this.code, this.message, this.span);

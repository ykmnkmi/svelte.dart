...
class MinimizeWhitespaceVisitor extends RecursiveTemplateAstVisitor<bool> {
  ...
  List<StandaloneTemplateAst> visitAllRoot(
    List<StandaloneTemplateAst> rootNodes,
      ...
      visitAll(_visitRemovingWhitespace(rootNodes)) as List<StandaloneTemplateAst>;
  ...
  static bool _isPotentiallyInline(ElementAst astNode) => _commonInlineElements.contains(astNode.name.toLowerCase());

...
void testRecoverySolution(
  ...
  for (var type in encounteredTokens) {
    ...
    test('should resolve: unexpected $type in $startState', () async {
      ...
      } else if (expectedSyntheticType == NgTokenType.doubleQuote || expectedSyntheticType == NgTokenType.singleQuote) {
        var left = NgToken.generateErrorSynthetic(recoveryOffset, expectedSyntheticType);
        var value = NgToken.generateErrorSynthetic(recoveryOffset, NgTokenType.elementDecoratorValue);
        var right = NgToken.generateErrorSynthetic(recoveryOffset, expectedSyntheticType);
...
void comment() {
  test('should resolve: unexpected EOF in scanComment', () {
    ...
    expect(
      results,
      [NgToken.commentStart(0), NgToken.commentValue(4, ' some comment '), NgToken.commentEnd(18)],
    );
    checkException(ParserErrorCode.UNTERMINATED_COMMENT, 0, 18);
    expect(untokenize(results), '<!-- some comment -->');
  });
...
void afterElementIdentifierOpen() {
  ...
  test('Testing resolved strings of $startState', () {
    ...
    checkException(ParserErrorCode.EXPECTED_WHITESPACE_BEFORE_NEW_DECORATOR, 1, 3);
...
void afterElementDecorator() {
  ...
  test('Testing resolved strings of $startState', () {
    ...
    checkException(ParserErrorCode.EXPECTED_WHITESPACE_BEFORE_NEW_DECORATOR, 9, 1);
    expect(untokenize(tokenize('<div blah(evnt)>')), '<div blah (evnt)>');
    checkException(ParserErrorCode.EXPECTED_WHITESPACE_BEFORE_NEW_DECORATOR, 9, 1);
    expect(untokenize(tokenize('<div blah[(bnna)]>')), '<div blah [(bnna)]>');
    checkException(ParserErrorCode.EXPECTED_WHITESPACE_BEFORE_NEW_DECORATOR, 9, 2);
    expect(untokenize(tokenize('<div blah]>')), '<div blah []>');
    checkException(ParserErrorCode.EXPECTED_WHITESPACE_BEFORE_NEW_DECORATOR, 9, 1);
    expect(untokenize(tokenize('<div blah)>')), '<div blah ()>');
    checkException(ParserErrorCode.EXPECTED_WHITESPACE_BEFORE_NEW_DECORATOR, 9, 1);
    ...
    checkException(ParserErrorCode.EXPECTED_WHITESPACE_BEFORE_NEW_DECORATOR, 11, 5);

    // Resolve2 types
    expect(untokenize(tokenize('<div blah')), '<div blah>');
    checkException(ParserErrorCode.EXPECTED_TAG_CLOSE, 5, 4);
    expect(untokenize(tokenize('<div blah<!--comment-->')), '<div blah><!--comment-->');
    checkException(ParserErrorCode.EXPECTED_TAG_CLOSE, 5, 4);
...
void afterElementDecoratorValue() {
  ...
  test('Testing resolved strings of $startState', () {
    // Resolve1 types
    expect(untokenize(tokenize('<div someName="someValue"[prop]>')), '<div someName="someValue" [prop]>');
    checkException(ParserErrorCode.EXPECTED_WHITESPACE_BEFORE_NEW_DECORATOR, 14, 11);
    expect(untokenize(tokenize('<div someName="someValue"(evnt)>')), '<div someName="someValue" (evnt)>');
    checkException(ParserErrorCode.EXPECTED_WHITESPACE_BEFORE_NEW_DECORATOR, 14, 11);
    expect(untokenize(tokenize('<div someName="someValue"[(bnna)]>')), '<div someName="someValue" [(bnna)]>');
    checkException(ParserErrorCode.EXPECTED_WHITESPACE_BEFORE_NEW_DECORATOR, 14, 11);
    expect(untokenize(tokenize('<div someName="someValue"#ref>')), '<div someName="someValue" #ref>');
    checkException(ParserErrorCode.EXPECTED_WHITESPACE_BEFORE_NEW_DECORATOR, 14, 11);
    expect(untokenize(tokenize('<div someName="someValue"*temp>')), '<div someName="someValue" *temp>');
    checkException(ParserErrorCode.EXPECTED_WHITESPACE_BEFORE_NEW_DECORATOR, 14, 11);
    expect(untokenize(tokenize('<div someName="someValue"@temp>')), '<div someName="someValue" @temp>');
    checkException(ParserErrorCode.EXPECTED_WHITESPACE_BEFORE_NEW_DECORATOR, 14, 11);
    expect(untokenize(tokenize('<div someName="someValue"]>')), '<div someName="someValue" []>');
    checkException(ParserErrorCode.EXPECTED_WHITESPACE_BEFORE_NEW_DECORATOR, 14, 11);
    expect(untokenize(tokenize('<div someName="someValue")>')), '<div someName="someValue" ()>');
    checkException(ParserErrorCode.EXPECTED_WHITESPACE_BEFORE_NEW_DECORATOR, 14, 11);
    expect(untokenize(tokenize('<div someName="someValue")]>')), '<div someName="someValue" [()]>');
    checkException(ParserErrorCode.EXPECTED_WHITESPACE_BEFORE_NEW_DECORATOR, 14, 11);
    expect(untokenize(tokenize('<div someName="someValue"blah>')), '<div someName="someValue" blah>');
    checkException(ParserErrorCode.EXPECTED_WHITESPACE_BEFORE_NEW_DECORATOR, 14, 11);
    ...
    expect(untokenize(tokenize('<div someName="someValue"<!--comment-->')), '<div someName="someValue"><!--comment-->');
    checkException(ParserErrorCode.EXPECTED_TAG_CLOSE, 14, 11);
    expect(untokenize(tokenize('<div someName="someValue"<span>')), '<div someName="someValue"><span>');
    checkException(ParserErrorCode.EXPECTED_TAG_CLOSE, 14, 11);
    expect(untokenize(tokenize('<div someName="someValue"</div>')), '<div someName="someValue"></div>');
    checkException(ParserErrorCode.EXPECTED_TAG_CLOSE, 14, 11);
...
void elementDecorator() {
  ...
  test('Testing resolved strings of $startState', () {
    ...
    // Resolve2 types
    expect(untokenize(tokenize('<div ]>')), '<div []>');
    checkException(ParserErrorCode.ELEMENT_DECORATOR_SUFFIX_BEFORE_PREFIX, 5, 1);
    expect(untokenize(tokenize('<div )>')), '<div ()>');
    checkException(ParserErrorCode.ELEMENT_DECORATOR_SUFFIX_BEFORE_PREFIX, 5, 1);
    expect(untokenize(tokenize('<div )]>')), '<div [()]>');
    checkException(ParserErrorCode.ELEMENT_DECORATOR_SUFFIX_BEFORE_PREFIX, 5, 2);
...
void elementDecoratorValue() {
  ...
  test('Testing resolved strings of $startState', () {
    ...
    checkException(ParserErrorCode.ELEMENT_DECORATOR_VALUE, 9, 1);
    expect(untokenize(tokenize('<div attr=[(bnna)]>')), '<div attr="" [(bnna)]>');
    checkException(ParserErrorCode.ELEMENT_DECORATOR_VALUE, 9, 1);
    expect(untokenize(tokenize('<div attr=]>')), '<div attr="" []>');
    checkException(ParserErrorCode.ELEMENT_DECORATOR_VALUE, 9, 1);
    expect(untokenize(tokenize('<div attr=)>')), '<div attr="" ()>');
    ...
    expect(untokenize(tokenize('<div attr=)]>')), '<div attr="" [()]>');
    checkException(ParserErrorCode.ELEMENT_DECORATOR_VALUE, 9, 1);
    expect(untokenize(tokenize('<div attr=<!--comment-->')), '<div attr=""><!--comment-->');
    checkException(ParserErrorCode.ELEMENT_DECORATOR_VALUE, 9, 1);
    ...
    checkException(ParserErrorCode.ELEMENT_DECORATOR_VALUE_MISSING_QUOTES, 10, 5);
...
void suffixBanana() {
  ...
  test('Testing resolved strings of $startState', () {
    ...
    checkException(ParserErrorCode.SUFFIX_BANANA, 5, 6);
    expect(untokenize(tokenize('<div [(bnna[(bnna2)]>')), '<div [(bnna)] [(bnna2)]>');
    checkException(ParserErrorCode.SUFFIX_BANANA, 5, 6);
    expect(untokenize(tokenize('<div [(bnna]>')), '<div [(bnna)] []>');
    checkException(ParserErrorCode.SUFFIX_BANANA, 5, 6);
    expect(untokenize(tokenize('<div [(bnna)>')), '<div [(bnna)] ()>');
    ...
    expect(untokenize(tokenize('<div [(bnna@templ>')), '<div [(bnna)] @templ>');
    checkException(ParserErrorCode.SUFFIX_BANANA, 5, 6);
    expect(untokenize(tokenize('<div [(bnna<!--comment-->')), '<div [(bnna)]><!--comment-->');
    checkException(ParserErrorCode.SUFFIX_BANANA, 5, 6);
    ...
    expect(untokenize(tokenize('<div [(bnna')), '<div [(bnna)]>');
    checkException(ParserErrorCode.SUFFIX_BANANA, 5, 6);
    expect(untokenize(tokenize('<div [(bnna="quote">')), '<div [(bnna)]="quote">');
    checkException(ParserErrorCode.SUFFIX_BANANA, 5, 6);
    expect(untokenize(tokenize('<div [(bnna"quote">')), '<div [(bnna)]="quote">');
    checkException(ParserErrorCode.SUFFIX_BANANA, 5, 6);
    expect(untokenize(tokenize("<div [(bnna'quote'>")), "<div [(bnna)]='quote'>");
...
void suffixEvent() {
  ...
  test('Testing resolved strings of $startState', () {
    ...
    checkException(ParserErrorCode.SUFFIX_EVENT, 5, 5);
    expect(untokenize(tokenize('<div (evnt[(bnna)]>')), '<div (evnt) [(bnna)]>');
    checkException(ParserErrorCode.SUFFIX_EVENT, 5, 5);
    expect(untokenize(tokenize('<div (evnt]>')), '<div (evnt) []>');
    checkException(ParserErrorCode.SUFFIX_EVENT, 5, 5);
    expect(untokenize(tokenize('<div (evnt)]>')), '<div (evnt) [()]>');
    ...
    expect(untokenize(tokenize('<div (evnt@templ>')), '<div (evnt) @templ>');
    checkException(ParserErrorCode.SUFFIX_EVENT, 5, 5);
    expect(untokenize(tokenize('<div (evnt<!--comment-->')), '<div (evnt)><!--comment-->');
    checkException(ParserErrorCode.SUFFIX_EVENT, 5, 5);
...
void suffixProperty() {
  ...
  test('Testing resolved strings of $startState', () {
    ...
    checkException(ParserErrorCode.SUFFIX_PROPERTY, 5, 5);
    expect(untokenize(tokenize('<div [prop[(bnna)]>')), '<div [prop] [(bnna)]>');
    checkException(ParserErrorCode.SUFFIX_PROPERTY, 5, 5);
    expect(untokenize(tokenize('<div [prop)>')), '<div [prop] ()>');
    checkException(ParserErrorCode.SUFFIX_PROPERTY, 5, 5);
    expect(untokenize(tokenize('<div [prop)]>')), '<div [prop] [()]>');
    ...
    expect(untokenize(tokenize('<div [prop@templ>')), '<div [prop] @templ>');
    checkException(ParserErrorCode.SUFFIX_PROPERTY, 5, 5);
    expect(untokenize(tokenize('<div [prop<!--comment-->')), '<div [prop]><!--comment-->');
    checkException(ParserErrorCode.SUFFIX_PROPERTY, 5, 5);

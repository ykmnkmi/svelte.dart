...
void main() {
  Iterable<NgSimpleToken> tokenize(String html) => const NgSimpleTokenizer().tokenize(html);
  ...
  test('should tokenize dangling double quote', () {
    expect(tokenize('''<div [someInput]=" (someEvent)='do something'>'''), [
      ...
      NgSimpleToken.closeBracket(15),
      NgSimpleToken.equalSign(16),
      NgSimpleQuoteToken.doubleQuotedText(17, '" (someEvent)=\'do something\'>', false),
  ...
  test('should tokenize dangling single quote', () {
    expect(tokenize('''<div [someInput]=' (someEvent)="do something">'''), [
      ...
      NgSimpleToken.closeBracket(15),
      NgSimpleToken.equalSign(16),
      NgSimpleQuoteToken.singleQuotedText(17, "' (someEvent)=\"do something\">", false),
      NgSimpleToken.EOF(46),
    ]);
  });

...
void main() {
  ...
  test('doubleQuotedText - closed', () {
    var quoteToken = NgSimpleQuoteToken.doubleQuotedText(0, '"this is a \"quoted\" text"', true);
  ...
  test('doubleQuotedText - open', () {
    var quoteToken = NgSimpleQuoteToken.doubleQuotedText(0, '"this is a \"quoted\" text', false);
    expect(quoteToken.contentLexeme, 'this is a \"quoted\" text');
    expect(quoteToken.contentEnd, 24);
    expect(quoteToken.contentLength, 23);
    expect(quoteToken.contentOffset, 1);
  ...
  test('singleQuotedText - closed', () {
    var quoteToken = NgSimpleQuoteToken.singleQuotedText(0, "'this is a \'quoted\' text'", true);
    expect(quoteToken.contentLexeme, "this is a \'quoted\' text");
    expect(quoteToken.contentEnd, 24);
    expect(quoteToken.contentLength, 23);
    expect(quoteToken.contentOffset, 1);
  ...
  test('doubleQuotedText - open', () {
    var quoteToken = NgSimpleQuoteToken.singleQuotedText(0, "'this is a \'quoted\' text", false);
    expect(quoteToken.contentLexeme, "this is a \'quoted\' text");

...
base class App extends Component {
  ...
  video.svelte-11bzk4c {
    ...
    var time = state<int>(0);
    var duration = state<int?>(null);
    ...
    void handleMove(HTMLElement element, MouseEvent event) {
      ...
      time.set((duration()! * (clientX - left) / (right - left)).toInt());
    }
    ...
    $.templateEffect(() {
      ...
      $.setValue(progress, duration() == null ? 0 : time() / duration()!);
      $.setText(
        text1,
    ...
    $.bindCurrentTimeState(video, time);
    $.bindProperty(
      'duration',
      'durationchange',
      video,
